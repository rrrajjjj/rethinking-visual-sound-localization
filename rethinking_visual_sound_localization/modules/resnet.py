# Copied and modified from https://github.com/hche11/VGGSound/blob/master/models/resnet.py
# and https://github.com/hche11/Localizing-Visual-Sounds-the-Hard-Way/blob/main/models/resnet.py
